...
abstract class AppTextStyles {
  ...
  static const TextStyle boldOverline = TextStyle(
    fontFamily: fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w700,
    height: 1.5,
  ...
  // SemiBold
  static const TextStyle semiBoldTitle = TextStyle(
    fontFamily: fontFamily,
    fontSize: 20,
  ...
  static const TextStyle semiBoldSubtitle = TextStyle(
    fontFamily: fontFamily,
    fontSize: 18,
    fontWeight: FontWeight.w600,
    height: 1.5,
  ...
  static const TextStyle semiBoldBody = TextStyle(
    fontFamily: fontFamily,
    fontSize: 16,
    fontWeight: FontWeight.w600,
    height: 1.5,
  ...
  static const TextStyle semiBoldCaption = TextStyle(
    fontFamily: fontFamily,
    fontSize: 14,
    fontWeight: FontWeight.w600,
    height: 1.5,
  ...
  static const TextStyle semiBoldOverline = TextStyle(
    fontFamily: fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w600,
    height: 1.5,
  ...
  static const TextStyle mediumOverline = TextStyle(
    fontFamily: fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w500,
    height: 1.5,
  ...
  static const TextStyle regularBody = TextStyle(
    fontFamily: fontFamily,
    fontSize: 16,
    fontWeight: FontWeight.w400,
    height: 1.5,
  ...
  static const TextStyle regularOverline = TextStyle(
    fontFamily: fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w400,
    height: 1.5,
  ...
  static const TextStyle lightOverline = TextStyle(
    fontFamily: fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w300,
    height: 1.5,
